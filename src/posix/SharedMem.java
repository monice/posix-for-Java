...
/**
 * A Posix shared memory segment. Shared physical memory is not supported, since
 * this requires superuser privilege and is very hardware dependent.
 * 
...
public class SharedMem extends IPC {
	...
	/**
	 * The modulus for attaching shared memory by logical address. This is
	 * system dependent and therefore computed by the class initializer. While
	 * attaching shared memory to a specific address is somewhat system
	 * dependent, it can be handled by configuration or property settings.
	 */
	 ...
	 * While posix supports attaching at a specific address (within system
	 * dependent contraints), I cannot see any utility for this in a Java
	 * program - so it is not supported for now.
	 * 
	 * FIXME: support attaching readonly. Support detaching and reattaching at
	 * the same address to change readonly status.
	 * 
